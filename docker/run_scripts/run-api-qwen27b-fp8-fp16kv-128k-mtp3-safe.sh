...
ROUTE_ID="qwen27b-fp8-fp16kv-128k-mtp3-safe"
PROFILE_REF="profiles/qwen27b/safe/fp8/fp16kv-128K-mtp3-text-only.env"
SERVED_NAME="${SERVED_NAME:-qwen27b-fp8-fp16kv-128K-mtp3-text-only-cu128}"
MODE="${MODE:-safe}"
MODEL_FAMILY="qwen"
MODEL_VARIANT="fp8"
